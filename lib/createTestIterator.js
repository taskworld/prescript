...
function createTestIterator (visitor) {
  ...
  return {
    ...
    begin (beginningStep) {
      stepper = createStepper(test, beginningStep, visitor)
    },
...
function createStepper (test, beginningStep, visitor) {
